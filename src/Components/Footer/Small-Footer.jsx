function SmallFooter() {
    return (
        <>
            <footer className="xl:hidden my-12 flex justify-center">
                <nav className="xs:w-1/2 flex flex-wrap justify-center gap-1 gap-y-3 text-sm text-border brightness-75 -z-10">
                    ...
                    <span> • </span>
                    <a className="link link-hover">Pengiriman</a>
                    <span> • </span>
